...
class App extends VuexModule implements AppState {
  ...
  public sidebar = true;
  public navTheme = config.navTheme;
  public primaryColor = config.primaryColor;
  public layoutMode = config.layoutMode;
  public contentWidth = config.contentWidth;
  public colorWeak = config.colorWeak;
  public fixedHeader = config.fixedHeader;
  public autoHideHeader = config.autoHideHeader;
